...
describe('Insertion Sort\'s module', () => {
    ...
    describe(', given a random array of 10 non-unique numbers,', () => {
        ...
        it('returns a sorted array', () => {
            const result = SortableArray.insertionSort((item1, item2) => item1 < item2, false);
        ...
        it('yields the steps to sorting the array', () => {
            const generator = SortableArray.insertionSort((item1, item2) => item1 < item2, true);
            let done = false;
            let currentNext;
